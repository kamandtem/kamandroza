  ...
  if (logged < MIN_DAYS) {
    return (
      <EmptyState
        ...
        descriptionFa="وقتی چند روز روتین و حال پوستت را ثبت کنی، رزا روند واقعی را به‌ت نشان می‌دهد. تا آن موقع عدد الکی نشان نمی‌دهیم."
    ...
    <div className="p-4 rounded-3xl bg-white dark:bg-slate-900 border border-rose-100 dark:border-slate-800 space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-0.5 shrink-0"
        >
          جزئیات
