...
export const PROCEDURE_RULES: ProcedureRule[] = [
  ...
  },
  {
    ...
    aftercareChecklistFa: ['تا ۲۴ ساعت محصولات قوی مثل رتینول و لایه‌بردارها را نزنید؛ فقط تسکین‌دهنده و ضدآفتاب.'],
    discouragedPhases: ['menstrual'],
    discouragedInPms: true,
    preferredPhases: ['follicular', 'ovulation'],
  ...
  },
  {
    ...
    aftercareChecklistFa: ['۷ روز روی ابرو محصولات قوی مثل رتینول و لایه‌بردارها را نزنید.', 'ناحیه را خشک نگه دارید.'],
    discouragedPhases: ['menstrual'],
    discouragedInPms: true,
    preferredPhases: ['follicular'],
